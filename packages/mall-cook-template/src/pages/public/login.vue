			...
			<view class="uForm">
			  <u-form :model="ruleForm" ref="uForm">
				...
				<u-form-item label-width="150" label="密码">
				  <u-input v-model="ruleForm.password" placeholder="请输入登录密码" type="password" @input ="passwordInput"/>
				</u-form-item>
			  </u-form>
			</view>
			<view class="padding">
				<u-button shape="circle" type="error" :disabled="logining" @click="toLogin">登录</u-button>
			</view>
			<!--  #ifdef MP -->
			<view class="padding-lr">
        <u-button shape="circle" type="success" @click="modalName = 'agreement'">授权登录</u-button>
			</view>
			<!--  #endif -->
