	...
	<view class="container">
      ...
      <view class="uForm">
        <u-form :model="ruleForm" ref="uForm">
          ...
          <u-form-item label-width="150" label="密码">
            <u-input v-model="ruleForm.password" placeholder="请输入密码" type="password" @input ="passwordInput"/>
          </u-form-item>
          <u-form-item label-width="150" label="重复密码">
            <u-input v-model="ruleForm.rPassword" placeholder="请再次输入密码" type="password" @input ="rPasswordInput"/>
          </u-form-item>
        </u-form>
      </view>
      <view class="padding">
        <u-button shape="circle" type="error" @click="toRegister">注册</u-button>
      </view>
