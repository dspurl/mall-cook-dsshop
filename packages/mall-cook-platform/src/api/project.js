...
export const getProjectById = async data =>
  request({ url: 'project/1', method: 'GET', data })
...
export const editProject = async data =>
  request({ url: 'project/1', method: 'POST', data })
...
export const uploadCover = async data =>
  request({ url: 'uploadPictures', method: 'POST', data })

/**
 * 生成小程序码
 */
export const createWXcode = async data =>
  request({ url: 'projectQr', method: 'POST', data })
